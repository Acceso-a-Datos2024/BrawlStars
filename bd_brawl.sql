...
alter table StarPowers add INDEX idx_brawlerid (brawlerId);
alter table Brawlers add INDEX idx_brawlerid2 (id);
alter table StarPowers add FOREIGN KEY (brawlerId) REFERENCES Brawlers(id);
alter table Gadgets add FOREIGN KEY (brawlerId) REFERENCES Brawlers(id);
alter table Gears add FOREIGN KEY (brawlerId) REFERENCES Brawlers(id);

alter table Players add FOREIGN KEY (clubTag) REFERENCES Clubs(tag);
alter table ClubMembers add FOREIGN KEY (clubTag) REFERENCES Clubs(tag);
alter table Battles add FOREIGN KEY (playerTag) REFERENCES Players(tag);
alter table Brawlers add FOREIGN KEY (playerTag) REFERENCES Players(tag);
alter table Gears add FOREIGN KEY (playerTag) REFERENCES Players(tag);
